...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Use CuTile W8A8 blockwise FP8 GEMM kernel instead of CUTLASS/Triton.
    "VLLM_SWITCH_CUTILE": lambda: bool(int(os.getenv("VLLM_SWITCH_CUTILE", "0"))),
